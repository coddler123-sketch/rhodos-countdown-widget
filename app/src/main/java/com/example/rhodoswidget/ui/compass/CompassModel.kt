...
internal fun matchesCompassQuickFilter(tip: CompassTip, filter: String): Boolean = when (filter) {
    "📍 Kolymbia & Ostküste" -> tip.location.contains("Kolymbia", ignoreCase = true) ||
        tip.location.contains("Tsambika", ignoreCase = true) ||
        tip.location.contains("Stegna", ignoreCase = true) ||
        tip.location.contains("Archangelos", ignoreCase = true) ||
        tip.location.contains("Afandou", ignoreCase = true)
    "🏛️ Rhodos-Stadt & Norden" -> tip.location.contains("Rhodos", ignoreCase = true) ||
        tip.location.contains("Altstadt", ignoreCase = true) ||
        tip.location.contains("Kallithea", ignoreCase = true) ||
        tip.location.contains("Ialyssos", ignoreCase = true)
    "🏰 Lindos & Süden" -> tip.location.contains("Lindos", ignoreCase = true) ||
        tip.location.contains("Pefkos", ignoreCase = true) ||
        tip.location.contains("Prasonisi", ignoreCase = true) ||
        tip.location.contains("Lardos", ignoreCase = true)
    "🌲 Inland & Westküste" -> tip.location.contains("Seven Springs", ignoreCase = true) ||
        tip.location.contains("Eleousa", ignoreCase = true) ||
        tip.location.contains("Monolithos", ignoreCase = true) ||
        tip.location.contains("Kamiros", ignoreCase = true) ||
        tip.location.contains("Archipoli", ignoreCase = true) ||
        tip.location.contains("Profitis Ilias", ignoreCase = true)
